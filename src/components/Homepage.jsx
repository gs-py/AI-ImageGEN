...
const Homepage = () => {
  ...
  return (
    ...
    <section className=" h-[100dvh] flex justify-center items-center transition-all duration-1000 bg-[url('/3d-render-modern-background-with-flowing-cyber-dots-design.jpg')] bg-cover">
          ...
          <div className=" h-[90vh] m-2 scroll-smooth  w-[100vw]  container  rounded-lg overflow-x-clip overflow-y-hidden p-2 text-white  flex justify-evenly  items-center  flex-col ">
            
              {/* <div className=" text-[#FF7F3E] w-full flex justify-center "></div> */}
          
              <div className=" flex  justify-evenly  w-full items-center flex-nowrap gap-5 ">
                  
                  <div className=" w-[35dvw] sm:w-[30dvw] bg-[#80C4E9]/20  rounded-lg sm:h-[35dvh] h-[25dvh] flex justify-evenly flex-col  gap-2 p-4 flow1 flex-nowrap  text-pretty items-stretch hover:scale-95 transition-all duration-400 anima  min-h-fit backdrop-blur-sm sm:backdrop-blur ">
                  ...
                  <div className=" w-[35dvw] sm:w-[30dvw] bg-[#80C4E9]/20 rounded-lg sm:h-[35dvh] h-[25dvh] flow flex justify-evenly flex-col gap-2 p-4 min-h-fit  items-stretch hover:scale-95 transition-all duration-400  anima backdrop-blur-sm sm:backdrop-blur"> 
